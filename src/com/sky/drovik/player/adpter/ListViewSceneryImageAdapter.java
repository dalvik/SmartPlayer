...
public class ListViewSceneryImageAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null) {
			...
			//获取控件对象
			itemView.name = (TextView)convertView.findViewById(R.id.scenery_image_list_item_name);
			itemView.desc = (TextView)convertView.findViewById(R.id.scenery_image_list_item_desc);
			itemView.src= (ImageView)convertView.findViewById(R.id.scenery_image_list_item_thumbnail);
